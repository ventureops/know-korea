...
<p>Within 90 days of arrival you must register at your local Immigration Office. Bring your passport, visa, one passport-sized photo, and proof of address. This card becomes your Korean ID for everything from opening a bank account to signing up for mobile plans.</p>
...
<p>Mobile Virtual Network Operators run on the same towers as the big three carriers but cost 40-60% less. Hello Mobile and Helios are popular with expats. You can sign up online in English with just your ARC and a Korean bank account.</p>',
...
<p>Korean menus are increasingly visual — pointing is perfectly acceptable. When you''re ready to pay, catch the server''s eye and say <em>계산서 주세요</em> or simply <em>계산이요!</em>. Most places now have table buzzers or QR ordering.</p>',
...
<p>A slight bow (15-30 degrees) is the standard greeting. Deep bows (45-90 degrees) are reserved for formal apologies or greeting elders. Handshakes are common in business — often paired with a slight bow. Never offer your left hand.</p>
...
<h2 id="food">Food</h2>
<p>Eating Korean food keeps costs low: lunch at a local 식당 averages 8,000-12,000 KRW, convenience store meals 4,000-7,000 KRW. Western food and imported groceries cost 2-3x more. Cook at home from Emart or Homeplus to save significantly.</p>',
